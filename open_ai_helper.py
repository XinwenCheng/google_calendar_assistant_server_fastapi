...
class OpenAIHelper:
    ...
    def check_conflict(schedule_text:str,event_data:object,user_text:str,result_json:object):
        prompt = PromptHelper.get_prompt_check_conflict(schedule_text=schedule_text,event_data=event_data)
        ...
        if conflict_data.get("conflict"):
            print(f"OpenAIHelper check_conflict() conflict reason: {conflict_data.get('reason')}")
